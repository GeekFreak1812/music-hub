...
import { idlFactory } from './nftune_frontend.did.js';
export { idlFactory } from './nftune_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NFTUNE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./nftune_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the nftune_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./nftune_frontend.did.js")._SERVICE>}
 */
export const nftune_frontend = createActor(canisterId);
